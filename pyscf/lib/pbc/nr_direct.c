                          ...
                          CVHFOpt *vhfopt, CINTEnvVars *envs_cint, BVKEnvs *envs_bvk)
{
        ...
        if (!(*intor)(buf, cell0_shls, bvk_cells, direct_scf_cutoff,
...
void PBCVHF_direct_drv(void (*fdot)(), int (*intor)(),
                       ...
                       int bvk_ncells, int nkpts, int nbands, int nbasp, int comp,
                       int *sh_loc, int *cell0_ao_loc, int *shls_slice,
                       int *dm_translation, char *ovlp_mask,
