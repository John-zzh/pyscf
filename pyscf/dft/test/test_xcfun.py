...
class KnownValues(unittest.TestCase):
    ...
    def test_vs_libxc_rks(self):
        ...
        #?check('TPSS,' ,                                  k_place=-4)  # fxc very different
        #?check('REVTPSS,', deriv=1)  # xcfun crash
        check('APBE,')
        #?check('BLOC,' ,                                  k_place=-5)  # fxc very different
    ...
    def test_vs_libxc_uks(self):
        ...
        check(',vwn5')
        check(',pbe'  , deriv=3, e_place=4, v_place=4, f_place=4, k_place=3)
        #?check(',br')
        #?check(',LDAERF')
        check(',lyp'  , deriv=3, e_place=5, v_place=5, f_place=3, k_place=2)
        check(',SPBE' , deriv=3, e_place=1, v_place=1, f_place=0, k_place=-1)
        check(',PW91' , deriv=3, e_place=4, v_place=3, f_place=2, k_place=-2)
        check(',m052x', deriv=1)
        check(',m05'  , deriv=1)
        check(',m06'  , deriv=1)
        check(',m062x', deriv=1)
        check(',m06l' , deriv=1)
        check(',TPSS' , deriv=3, e_place=4, v_place=3, f_place=-2, k_place=-2)
        check(',REVTPSS', deriv=1, e_place=2, v_place=1)
        check(',p86'    , deriv=3, e_place=4, v_place=4, f_place=2, k_place=-1)
        check(',APBE'   , deriv=3, e_place=4, v_place=4, f_place=4, k_place=3)
        check(',PBEINT' , deriv=3, e_place=5, v_place=4, f_place=4, k_place=3)
        check(',TPSSLOC', deriv=1, e_place=4, v_place=2)

        #?check('br')
        check('revpbe', deriv=3, e_place=4, v_place=4, f_place=4, k_place=3)
        check('b97'   , deriv=3, e_place=6, v_place=5, f_place=3, k_place=-5)
        #?check('b97_1')
        #?check('b97_2')
        check('SVWN')
        check('BLYP'  , deriv=3, e_place=5, v_place=5, f_place=3, k_place=2)
        check('BP86'  , deriv=3, e_place=4, v_place=4, f_place=2, k_place=-1)
        check('OLYP'  , deriv=3, e_place=5, v_place=5, f_place=3, k_place=2)
        check('KT1'   , deriv=3,                                  k_place=-2)
        check('KT2'   , deriv=3,                                  k_place=-2)
        #?check('KT3')
        check('PBE0'   , deriv=3, e_place=4, v_place=4, f_place=4, k_place=3)
        check('B3P86'  , deriv=3, e_place=4, v_place=4, f_place=2, k_place=-1)
        check('B3P86G' , deriv=3, e_place=3, v_place=2, f_place=2, k_place=-1)
        check('B3PW91' , deriv=3, e_place=3, v_place=3, f_place=2, k_place=-1)
        check('B3PW91G', deriv=3, e_place=2, v_place=2, f_place=2, k_place=0)
        check('B3LYP'  , deriv=3, e_place=5, v_place=5, f_place=4, k_place=2)
        check('B3LYP5' , deriv=3, e_place=5, v_place=5, f_place=4, k_place=2)
        check('B3LYPG' , deriv=3, e_place=3, v_place=2, f_place=2, k_place=-2)
        check('O3LYP'  , deriv=3, e_place=3, v_place=2, f_place=1, k_place=-2)
        check('X3LYP'  , deriv=3, e_place=5, v_place=5, f_place=3, k_place=0)
        check('CAMB3LYP', deriv=3, e_place=5, v_place=5, f_place=3, k_place=0)
        check('B97_1'   , deriv=3, e_place=6, v_place=5, f_place=3, k_place=-4)
        check('B97_2'   , deriv=3, e_place=6, v_place=5, f_place=3, k_place=-3)
        check('TPSSH'   , deriv=1, e_place=4, v_place=3)
